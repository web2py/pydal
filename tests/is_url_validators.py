...
class TestIsUrl(unittest.TestCase):
    ...
    def testExceptionalUse(self):
        ...
        x = IS_URL(mode="generic", allowed_schemes=["https"], prepend_scheme="https")
        self.assertEqual(x("google.ca"), ("google.ca", "Enter a valid URL"))
...
class TestIsGenericUrl(unittest.TestCase):
    ...
    def testPrepending(self):
        ...
        self.assertEqual(self.x("https://google.ca"), ("https://google.ca", None))

        # Does not prepend if None type is not specified in allowed_scheme,
        # because a scheme is required

        y = IS_GENERIC_URL(allowed_schemes=["http", "blargg"], prepend_scheme="http")
...
class TestIsHttpUrl(unittest.TestCase):
    ...
    def testPrepending(self):
        ...
        # prepends scheme for abbreviated domains
        self.assertEqual(self.x("google.ca:8080"), ("http://google.ca:8080", None))
        ...
        self.assertEqual(
            y("google.ca"), ("https://google.ca", None)
        )  # prepends https if asked

        z = IS_HTTP_URL(prepend_scheme=None)
        self.assertEqual(
            z("google.ca:8080"), ("google.ca:8080", None)
        )  # prepending disabled
