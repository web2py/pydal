...
from .postgres import PostgresPsyco
...
class GooglePostgres(GoogleMigratorMixin, PostgresPsyco):
    uploads_in_blob = True
    drivers = ("psycopg2",)
...
from ..backend_base import BasicParser, JSONParser
...
from ..backend_base import repr_for_type, pre, representers
